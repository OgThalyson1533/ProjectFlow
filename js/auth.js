...
function openConfigPanel() {
  ...
  document.getElementById('cfg-ai-key').value = localStorage.getItem('pf_ai_key')  || '';
...
function saveConfig() {
  ...
  if (!url || !key) { showToast('Preencha URL e Anon Key do Supabase', true); return; }
  localStorage.setItem('pf_sb_url', url);
  localStorage.setItem('pf_sb_key', key);
  if (aiKey) localStorage.setItem('pf_ai_key', aiKey);
  else localStorage.removeItem('pf_ai_key');
